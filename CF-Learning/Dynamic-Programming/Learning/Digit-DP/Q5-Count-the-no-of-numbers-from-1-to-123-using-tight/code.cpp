...
// Input : 3 123
// Output : 124
// No of function calls => approximately 124

// T.C. = O(stoi(s))
// string s could be very large 10^100 or 10^18 or 10^1e4
// Use digit dp to solve this problem

void solve() {
    cin >> N;
    cin >> s;

    ll tight = 1; // keep tight as 1 in the beginning
    // because we are starting from the first digit
    cout<<f(0LL, tight);
}
