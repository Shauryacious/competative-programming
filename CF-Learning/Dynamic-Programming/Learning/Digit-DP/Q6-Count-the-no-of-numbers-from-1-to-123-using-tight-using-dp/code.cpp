...
ll f(ll idx, ll tight){
    cout<<"Function called with idx = "<<idx<<" and tight = "<<tight<<nl;
    if(idx == N){
        return 1;
    }
...
// Total Function Calls: 30
// T.C. = n * 10 * 2
// n is the number of digits in the number i.e the size of the string
// 10 is the number of digits we can use (0-9) -> basically the base we are using
// 2 is the tight condition (0 or 1)
...
void solve() {
    ...
    memset(dp, -1, sizeof(dp));  // ✅ correct and safe here
