...
void solve(){
    ...
    cout<<"? 1 3"<<endl;
    ll aUb; cin>>aUb;
    ll aIntersectB = a+b-aUb; // Inclusion-Exclusion Principle
    vll ans;
    ans.pb(abs(a-aIntersectB)); // 1st element
    ans.pb(aIntersectB); // 2nd element
    ans.pb(abs(b-aIntersectB)); // 3rd element
