...
void solve() {
    ll w, h; cin>>w>>h;
    ll k1; cin>>k1;
    vll h1(k1); invec(h1, k1);
    ll k2; cin>>k2;
    vll h2(k2); invec(h2, k2);
    ll k3; cin>>k3;
    vll v1(k3); invec(v1, k3);
    ll k4; cin>>k4;
    vll v2(k4); invec(v2, k4);
    debug(h1);
    debug(h2);
    debug(v1);
    debug(v2);
    ll hmx = max(h1[k1-1] - h1[0], h2[k2-1] - h2[0]);
    ll vmx = max(v1[k3-1] - v1[0], v2[k4-1] - v2[0]);
    ll ans1 = hmx * h;
    ll ans2 = vmx * w;
